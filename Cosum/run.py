...
def main(train_file,
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        epoch_time, epoch_loss, epoch_acc, rouge_score, pyrouge_score = validate(model, valid_loader, criterion)

        valid_losses.append(epoch_loss)
        print("-> Valid. time: {:.4f}s, loss: {:.4f},accuracy: {:.4f}".format(epoch_time, epoch_loss, epoch_acc))
